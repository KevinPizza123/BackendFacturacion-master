...
public class ConceptoRest {
     ...
     * @return guardar
     */
    @PostMapping(value = "guardarConceptos")
    public ResponseEntity<?> create(@RequestBody ConceptoDto obj) {
        ConceptoDto dto = service.create(obj);
        ResponseGenerico<ConceptoDto> response = new ResponseGenerico<>();
        try {
     ...
     */
    @GetMapping(value = "listaConceptos")
    public ResponseEntity<?> listar() {
        ResponseGenerico<ConceptoDto> response = new ResponseGenerico<>();
        try {
            List<ConceptoDto> lista = service.findAll();
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
    ...
    @GetMapping(value = "buscarPorIdConceptos/{id}")
    public ResponseEntity<?> findById(@PathVariable int id) {
        ResponseGenerico<ConceptoDto> response = new ResponseGenerico<>();
        try {
            ConceptoDto dto = service.findById(id);
            response.setCodigoRespuestaName(HttpStatus.OK.name());
            response.setCodigoRespuestaValue(HttpStatus.OK.value());
            response.setObjeto(dto);
            response.setMensaje(EnumMessages.REGISTRO_EXISTENTE.name());
    ...
    @DeleteMapping(value = "eliminarConceptos/{id}")
